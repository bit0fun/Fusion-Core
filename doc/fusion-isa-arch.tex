...
%	\begin{tabular}{|c|c|c|} \hline
	\begin{longtable}{|l|l|l|}\hline
			...
			addc 		& Add Carry 				& 0x2 \\ \hline
			subc		& Subtract Carry(Borrow) 	& 0x3 \\ \hline
...
\begin{center}
	\begin{tabular}{|l|l|l|} \hline
			...
			adci 		& Add Carry Immediate				& 0x2 \\ \hline
			subci		& Subtract Carry(Borrow) Immediate 	& 0x3 \\ \hline
...
\subsection{List of Instructions}
	...
	\begin{center}
		\begin{longtable}{|l|l|c|}
			...
			addc		& Rd = RSa + RSb 								& 000001dddddaaaaabbbbbxxxxxx0010 \\
			subc		& Rd = RSa - RSb							 	& 000001dddddaaaaabbbbbxxxxxx0011 \\
			...
			addci		& Rd = RSa + Imm 								& 000011dddddaaaaaiiiiiiiiiii0010 \\
			subci		& Rd = RSa - Imm							 	& 000011dddddaaaaaiiiiiiiiiii0011 \\
